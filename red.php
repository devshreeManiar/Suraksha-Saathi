...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    <div class="w3-container" style="margin-top:60px" id="showcase">
        ...
        <h2>DON'T WORRY, WE ARE WITH YOU</h2>
    ...
    <div class="w3-row-padding">
        ...
        <div class="w3-half Container">
          ...
          <div id="map"></div>
          <p style="float:right;position:relative;top:-300px;left:500px"><a href="tel:9315913617"><img src="loc2.jpg" style="width:300px; border-radius:0px;"></a></p>
          <p style="float:right;position:relative;top:-250px;left:500px"><a href="tel:<?php
                                                                             
                                                                             $sql="SELECT Phone_no from family where User_ID='$us'";
                                                                             echo $sql;
                                                                             ?>
          "><img src="loc2.jpg" style="width:300px; border-radius:0px;"></a></p>
        </div>
